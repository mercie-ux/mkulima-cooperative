  ...
  return (
    <div className="min-h-screen bg-yellow-50 flex flex-col font-sans">
      ...
      <header className="relative text-white">
        ...
        <div className="relative z-10 container mx-auto px-6 py-32 md:py-48 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 ">
            <h1 className="text-4xl font-Heading md:text-5xl font-bold mb-4 leading-snug">
              Grow Better. Manage Smarter.
            </h1>
            <p className="text-lg font-body md:text-xl mb-6">
      ...
      <section className="py-16 container mx-auto px-6 text-center">
        <h2 className="text-3xl font-Heading font-bold mb-6 text-green-800">Why This App is for You</h2>
        <p className="text-lg font-body max-w-3xl mx-auto text-gray-800 mb-8">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-center relative">
            <div className="relative w-64 h-64">
              {images.map((img, index) => (
                <div
                  key={index}
                  className="absolute w-32 h-32 rounded-lg shadow-lg bg-white overflow-hidden animate-shuffle animate-flip"
                  style={{
